...
function populateSettingsUpdateInformation(data){
    if(data != null){
        settingsUpdateTitle.innerHTML = `Nouvelle ${isPrerelease(data.version) ? 'Pre-release' : 'Release'} Disponnible`
        ...
        if(process.platform === 'darwin'){
            settingsUpdateButtonStatus('Téléchargement depuis GitHub<span style="font-size: 10px;color: gray;text-shadow: none !important;">Close the launcher and run the dmg to update.</span>', false, () => {
        ...
        settingsUpdateButtonStatus('Vérifier Mises à jour', false, () => {
            if(!isDev){
