...
ipcMain.on('openMSALoginWindow', (ipcEvent, args) => {
    ...
    MSALoginWindow.loadURL('https://login.microsoftonline.com/consumers/oauth2/v2.0/authorize?prompt=select_account&client_id=' + clientID + '&response_type=code&scope=XboxLive.signin%20Xboxlive.offline_access%20offline_access&redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient')
})
